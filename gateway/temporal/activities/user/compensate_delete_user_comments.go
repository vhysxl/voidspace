...
const DeleteUserCommentsCompensateActivity = "DeleteUserCommentsCompensateActivity"

func (ua *UserActivities) DeleteUserCommentsCompensateActivity(
	ctx context.Context,
	...
	_, err := ua.CommentClient.HandleAccountRestoration(ctx, &commentpb.HandleAccountRestorationRequest{
