...
const (
	...
	PostService_Like_FullMethodName             = "/posts.v1.PostService/Like"
	PostService_Unlike_FullMethodName           = "/posts.v1.PostService/Unlike"
)
...
type PostServiceClient interface {
	...
	GetFeedByUserIDs(ctx context.Context, in *GetFeedByUserIDsRequest, opts ...grpc.CallOption) (*GetFeedByUserIDsResponse, error)
...
func (c *postServiceClient) GetFeedByUserIDs(ctx context.Context, in *GetFeedByUserIDsRequest, opts ...grpc.CallOption) (*GetFeedByUserIDsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetFeedByUserIDsResponse)
...
func (c *postServiceClient) Unlike(ctx context.Context, in *LikeRequest, opts ...grpc.CallOption) (*LikeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LikeResponse)
...
type PostServiceServer interface {
	...
	GetFeedByUserIDs(context.Context, *GetFeedByUserIDsRequest) (*GetFeedByUserIDsResponse, error)
...
func (UnimplementedPostServiceServer) GetFeedByUserIDs(context.Context, *GetFeedByUserIDsRequest) (*GetFeedByUserIDsResponse, error) {
...
func (UnimplementedPostServiceServer) Unlike(context.Context, *LikeRequest) (*LikeResponse, error) {
...
func _PostService_Unlike_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).Unlike(ctx, req.(*LikeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
