                        ...
                        <UForm :schema="editProfileSchema" :state="props.updateState" @submit="onSubmit"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <UFormField label="Location" name="location" class="md:col-span-2">
                                    <UInput v-model="updateState.location" color="neutral" placeholder="Your location"
                                        ...
                                        <template #content>
                                            <div class="p-6">
                                                ...
                                                <p class="text-gray-600 dark:text-gray-400 text-sm mb-6">
                                                    ...
                                                    Type your username <strong>{{ props.userData?.username }}</strong>
                                                    to confirm.
                                                </p>
                                                <!-- Confirmation Input -->
                                                <div class="mb-6">
                                                    <UInput color="neutral" placeholder="Enter your username to confirm"
